...
$.post("https://stock-management-system-server.herokuapp.com/get.php"/*"http://localhost/Mezzanine_Assignment/Mezzanine_Backend/get.php"*/, {
...
function buttonSelector() {
    $("button[id='NevAdd']").click(function() {
        ...
        $.post("https://stock-management-system-server.herokuapp.com/post.php"/*"http://localhost/Mezzanine_Assignment/Mezzanine_Backend/post.php"*/, {
    ...
    $("button[id='NevRemove']").click(function() {
        $(this).html("<i class='fas fa-spinner fa-spin fas-off'></i>");
        const clinicNumber = $(this).prop("name");
        $.post("https://stock-management-system-server.herokuapp.com/delete.php"/*"http://localhost/Mezzanine_Assignment/Mezzanine_Backend/delete.php"*/, {
            "medicationType": "NEVIRAPINE",
            "clinicNumber": clinicNumber,
            "selectedSortValue": $("#clinicSorting").val()
        }, function(returnedData, ourpoststatus) {
